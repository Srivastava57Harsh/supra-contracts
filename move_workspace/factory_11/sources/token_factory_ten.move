module 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::token_factory_gamma_testing_eleven {
    use std::string::String;
    use std::signer;
    use std::vector;
    use supra_framework::coin;
    use 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::custom_token_testing_eleven::{Self, Token0, Token1, Token2, Token3, Token4};
    ...
    public entry fun create_token(
        ...
        assert!(exists<TokenRecord>(factory_addr), E_NOT_INITIALIZED);
    ...
    fun deploy_specific_token<TokenType: key + store + copy + drop>(
        ...
        let (burn_cap, freeze_cap, mint_cap) = custom_token_testing_eleven::initialize<TokenType>(
            factory,
            token_owner,
            name,
            symbol,
