module 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::token_factory_gamma_testing_three {
    use std::string::String;
    use std::signer;
    use std::vector;
    use supra_framework::coin;
    use 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::custom_token_testing_three::{Self, Token0, Token1, Token2, Token3, Token4};
    ...
    fun deploy_specific_token<TokenType: key + store + copy + drop>(
        ...
        let creator_addr = signer::address_of(creator);
        let (burn_cap, freeze_cap, mint_cap) = custom_token_testing_three::initialize<TokenType>(
            creator,
            name,
            symbol,
            decimals
