module 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::token_factory_gamma_testing {
    use std::string::String;
    use std::signer;
    use std::vector;
    use supra_framework::coin::{Self, MintCapability};
    use 0x335faef3a35932c83b5a2f7cff5edee7a9ff38bcb5c1ad6dc176e43ebd9af471::custom_token_testing::{Self, Token0, Token1, Token2, Token3, Token4};
    ...
    struct TokenMintCap has key {
        mint_cap: MintCapability<custom_token_testing::TempToken>
    }
    ...
    fun deploy_specific_token<TokenType: key + store + copy + drop>(
        ...
        let creator_addr = signer::address_of(creator);
        let (burn_cap, freeze_cap, mint_cap) = custom_token_testing::initialize<TokenType>(
            creator,
            name,
            symbol,
            decimals
